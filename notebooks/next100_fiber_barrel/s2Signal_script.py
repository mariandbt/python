...
event_path = os.path.join(path, "bb/20240614_Next100_bb_300ev_ELoff_1.next.h5") 
...
s2table = s2sim.s2Table(s2_table_path, light_yield = 1050, n_ie = 5e7)


output_file_path  = os.path.join(path, 's2signals/TEST1.h5')
# output_file_path    = os.path.join(path, 's2signals/20240724_bb0nu_3Kev_ELoff_s2_signal_20240405s2table.h5')
